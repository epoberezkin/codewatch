...
- **Classification description**: AI-generated project summary (1-3 sentences), shown as muted text when present.
- **Category**: displayed as bold text with underscores replaced by spaces.
- **Involved parties**: vendor, operators, end_users, networks rendered as a middot-separated line via `renderInvolvedParties()` from `common.ts`. Hidden when no party data exists.
